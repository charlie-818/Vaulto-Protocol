...
export function WaitlistSuccess({ user }: WaitlistSuccessProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-[var(--background)]">
      ...
      <div className="animate-fade-in-up relative z-10 flex flex-col items-center px-6 text-center">
        ...
        {/* Success message */}
        <h1 className="animate-fade-in-up animation-delay-200 mb-6 text-3xl font-light text-[var(--foreground)] sm:text-4xl">
          You&apos;re on the list
        </h1>

        <p className="animate-fade-in-up animation-delay-300 mb-12 max-w-md text-[var(--muted)]">
          We&apos;ll notify{" "}
        ...
        <div className="animate-fade-in-up animation-delay-400 h-px w-32 overflow-hidden bg-[var(--border)]">
